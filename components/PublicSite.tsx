...
import { ARTIST_INFO, ARTWORKS, PRICING_TABLE } from '../constants'; // Asumo que el path a constants es correcto
...
// =======================================================
// 1. COMPONENTE AYUDANTE: Nuevo componente para renderizar listas detalladas
// =======================================================
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-slate-800">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        {/* ========================================= */}
        {/* BIO & TRAYECTORIA TAB (Actualizado para leer de constants.ts) */}
        {/* ========================================= */}
        {activeTab === 'bio' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            
            {/* Columna 1: Bio (Se mantiene) */}
            ...
            {/* Columna 2 & 3: Trayectoria (CORRECCIÓN) */}
            <div className="md:col-span-2 space-y-10">
              <h2 className="font-serif text-4xl font-bold text-slate-900 mb-6">Trayectoria & Reconocimientos</h2>
        ...
        {/* ========================================= */}
        {/* PRECIOS TAB (Se mantiene) */}
        {/* ========================================= */}
        {activeTab === 'prices' && (
          <div className="flex flex-col md:flex-row gap-12">
            
            {/* Commissions Info (Se mantiene) */}
