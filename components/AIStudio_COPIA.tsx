...
// --- CLAVE DE API DESDE VARIABLES DE ENTORNO (MÁS SEGURO) ---
const API_KEY_MASTER = import.meta.env.VITE_GOOGLE_API_KEY;

if (!API_KEY_MASTER) {
  console.warn("⚠️ API Key de Google no encontrada en variables de entorno (VITE_GOOGLE_API_KEY). La IA puede no funcionar.");
}
...
const TabButton: React.FC<TabButtonProps> = ({ tab, activeTab, setActiveTab, Icon, label }) => (
  <button
    ...
    className={`flex items-center gap-2 px-6 py-3 text-sm font-semibold transition-colors ${activeTab === tab
